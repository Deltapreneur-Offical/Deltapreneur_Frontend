...
export default function ShippingAndExchangePage() {
  return (
    <LegalPolicyShell
      ...
      intro="CoBrother primarily sells digital products and services. This page explains how delivery (“shipping”) works for domains and digital goods, and our exchange rules for banking and payment compliance."
      lastUpdated={LAST_UPDATED}
      sections={SECTIONS}
    >
      <PolicySection id="overview" title="1. Overview">
        <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
          CoBrother does not operate a physical warehouse or ship parcels for standard storefront purchases.
          Our products are delivered digitally through your CoBrother account, email, and/or registrar systems.
        </p>
      </PolicySection>
      ...
      <PolicySection id="nature" title="2. Nature of our products">
        ...
        <ul className="mt-2 list-disc pl-5 space-y-1 text-slate-600 text-sm sm:text-base leading-relaxed">
          ...
          <li>Professional and platform services arranged through CoBrother</li>
        </ul>
      </PolicySection>
      ...
      <PolicySection id="delivery" title="3. Digital delivery / “shipping”">
        ...
        <ul className="mt-2 list-disc pl-5 space-y-1 text-slate-600 text-sm sm:text-base leading-relaxed">
          ...
          <li>Order status, DNS/management tools (where applicable), and receipts are available in your CoBrother account.</li>
        </ul>
      ...
      <PolicySection id="exchange" title="5. Exchange policy">
        <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
          ...
          to a confirmed CoBrother error, contact support and we will correct the order or apply the Refund Policy
          as appropriate.
        </p>
        <p className="text-slate-600 text-sm sm:text-base leading-relaxed mt-3">
          See also:{' '}
