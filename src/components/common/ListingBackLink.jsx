 ...
 */
export default function ListingBackLink({ to, onClick, label, fallbackTo = '/', className = '' }) {
  ...
  return (
    <button
      ...
      className={`inline-flex w-fit items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-2.5 py-1.5 text-xs font-semibold text-gray-700 mb-4 transition-colors shadow-sm ${className}`.trim()}
