...
export const VA_FOLLOW_UP_TOOLTIP =
  'This Virtual Assistant is requested as part of your order. A CoBrother team member will contact you after your purchase to understand your requirements, provide the final quotation, and collect payment separately if you choose to proceed.';

export const SERVICE_FOLLOW_UP_TOOLTIP =
  'This service is requested as part of your order. A CoBrother team member will contact you after your purchase to understand your requirements, provide the final quotation, and collect payment separately if you choose to proceed.';
