...
export default function CancellationPolicyPage() {
  return (
    <LegalPolicyShell
      ...
      intro={`This Cancellation Policy explains how you can cancel an order or request before or after payment on CoBrother (${BUSINESS_LEGAL_NAME}), applicable timelines, and what happens next for digital products and domain services.`}
      lastUpdated={LAST_UPDATED}
      sections={SECTIONS}
      documentTitle="Cancellation Policy | CoBrother"
      documentDescription="CoBrother Cancellation Policy — cancel before or after payment, timelines, refunds within 5-7 business days, and contact details for cobrother.com."
    >
      <PolicySection id="overview" title="1. Overview">
        <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
          CoBrother offers digital marketplace and registration services. Cancellation options depend on whether you have
      ...
      <PolicySection id="timelines" title="4. Cancellation timelines">
        <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
          ...
          in your CoBrother account—whichever is earlier. We confirm cancellation requests within{' '}
