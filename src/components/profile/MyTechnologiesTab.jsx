    ...
    <div className="space-y-6">
      ...
      {subscriptions.length === 0 ? (
        <div className="rounded-2xl border-2 border-dashed border-gray-200 p-12 text-center bg-gray-50/50">
          ...
          <p className="mt-1 text-xs text-gray-500">Explore CoBrother Technology Services catalogue to provision new applications.</p>
          <a
            href="/technology"
      ...
      {selectedCredentials && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
          <div className="bg-white rounded-3xl max-w-md w-full p-8 shadow-2xl relative">
            ...
            <p className="text-xs text-gray-500 mb-4">White-labelled access details for your CoBrother service.</p>
