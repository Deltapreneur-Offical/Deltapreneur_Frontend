...
function DomainRow({ domain, type, onVerify }) {
  ...
  const shareMenu = shareOpen && shareMenuStyle && createPortal(
    <div
      ...
      className="bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden z-[9999]"
    >
      ...
      >
        <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
          <path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.09L12 16l-6.545-4.91v9.913H1.636A1.638 1.638 0 010 19.366V5.457c0-1.29 1.454-2.032 2.514-1.202L12 10.79l9.486-7.535c1.06-.83 2.514-.088 2.514 1.202z"/>
        </svg>
        Gmail
      </button>
      <button
