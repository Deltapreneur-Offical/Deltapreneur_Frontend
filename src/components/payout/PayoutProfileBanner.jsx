...
const CONTEXT_COPY = {
  default: {
    incomplete: 'Add your UPI or bank details so HubRegistrar can send payouts when a sale is completed.',
  ...
  coventure: {
    incomplete: 'Add your UPI or bank details now so you are ready for any future venture payouts from HubRegistrar.',
