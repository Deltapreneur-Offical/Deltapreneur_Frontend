    ...
    <div className="min-h-screen bg-white cb-body">
      ...
      <section className="relative overflow-hidden bg-slate-50 px-4 sm:px-6 lg:px-8 pt-20 pb-24 sm:pt-28 sm:pb-32">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          >
            Deltapreneur is a collaboration-driven ecosystem for founders, entrepreneurs, and
          ...
          <div className="max-w-2xl mb-14">
            ...
            <Reveal delay={0.1}>
              <h2 className="cb-display mt-5 text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 leading-tight flex items-center flex-wrap gap-x-2 gap-y-1">
                <span>What makes Deltapreneur different?</span>
              </h2>
            </Reveal>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-24 items-center">
          ...
          <div>
            ...
            <Reveal direction="left" delay={0.18}>
              <p className="mt-5 text-base sm:text-lg text-slate-600 leading-relaxed">
                Deltapreneur is built for people who are serious about execution — whether
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <Reveal delay={0.18}>
            <p className="mt-5 text-slate-400 text-base sm:text-lg leading-relaxed">
              Join Deltapreneur. Access technology. Build faster. Disrupt with confidence.
            </p>
          </Reveal>
          <Reveal delay={0.26}>
