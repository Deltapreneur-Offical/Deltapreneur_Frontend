...
export default function RefundPolicyPage() {
  return (
    <LegalPolicyShell
      ...
      intro={`This Refund Policy explains when and how ${BUSINESS_LEGAL_NAME} (CoBrother) issues refunds for payments made in INR on cobrother.com for domain registrations, marketplace purchases, technology products, and related digital services.`}
      lastUpdated={LAST_UPDATED}
      sections={SECTIONS}
      documentTitle="Refund Policy | CoBrother"
      documentDescription="CoBrother Refund Policy — eligibility, timelines (5-7 business days), how to request refunds, and grievance contact for cobrother.com."
    >
      <PolicySection id="overview" title="1. Overview">
        <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
          CoBrother is operated by {BUSINESS_LEGAL_NAME}. Payments on cobrother.com are processed securely through
