...
export function normalizeDomainRecord(raw) {
  ...
  return {
    ...
    gstInr: Number(raw.gstInr ?? raw.gst_inr ?? 0),
    gstRate: raw.gstRate ?? raw.gst_rate ?? null,
    gstEnabled: Boolean(raw.gstEnabled ?? raw.gst_enabled ?? false),
    buyerPayableInr: Number(raw.buyerPayableInr ?? raw.buyer_payable_inr ?? 0),
