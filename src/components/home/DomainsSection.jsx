...
export default function DomainsSection() {
  ...
  if (loading || !hasFetchedDomains) {
    return <HomeSectionCardSkeleton title={t('homeDomainRegister', { defaultValue: 'Domain Register' })} to="/domains" accent="domain" />;
  }
  ...
  return (
    <section className="bg-white pt-3 pb-4 md:pt-4 md:pb-6 min-w-0 overflow-visible">
      <div className="w-full min-w-0">
        <HomeSectionHeader
          title={t('homeDomainRegister', { defaultValue: 'Domain Register' })}
          to="/domains"
          accent="domain"
        ...
        {previewDomains.length === 0 ? (
          ...
          <HomeAutoScrollRow durationSec={40} ariaLabel={t('homeDomainRegister', { defaultValue: 'Domain Register' })}>
