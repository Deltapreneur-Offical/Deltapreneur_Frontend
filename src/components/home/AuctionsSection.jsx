...
export default function AuctionsSection() {
  ...
  if (loading) {
    return <HomeSectionCardSkeleton title={t('homeRegistryAuctions', { defaultValue: 'Registry Auctions' })} to="/auctions" accent="auction" variant="auction" />;
  }
  ...
  return (
    <section className="bg-white pt-2 pb-4 md:pt-3 md:pb-6 min-w-0 overflow-visible">
      <div className="w-full min-w-0">
        <HomeSectionHeader
          title={t('homeRegistryAuctions', { defaultValue: 'Registry Auctions' })}
          to="/auctions"
          accent="auction"
        ...
        {displayAuctions.length === 0 ? (
          ...
          <HomeAutoScrollRow durationSec={50} ariaLabel={t('homeRegistryAuctions', { defaultValue: 'Registry Auctions' })}>
