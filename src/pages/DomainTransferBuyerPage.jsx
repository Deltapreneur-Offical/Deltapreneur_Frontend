...
const timelineLabels = {
  ...
  ASSISTANCE_REQUESTED: 'Deltapreneur Assistance Requested',
...
export default function DomainTransferBuyerPage() {
  ...
  const requestHelp = () => run(
    ...
    'Deltapreneur assistance requested. A transfer specialist will guide you through the process.',
  );
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <p className="mt-2 max-w-2xl text-sm leading-6 text-gray-600">
                    Deltapreneur is holding your payment securely while the domain transfer is completed.
                  </p>
                </div>
                <StatusBadge tx={tx} />
              </div>
              ...
              <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                  ...
                  <button
                    ...
                    onClick={requestHelp}
                  >
                    <span className="font-semibold text-gray-950">Get Deltapreneur Assistance</span>
